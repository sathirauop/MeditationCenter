...
/**
 * Repository implementation for uploading program images to R2 storage.
...
public class PostProgramHttpRepository implements PostProgramHttpDataAccess {

    private static final Logger logger = LoggerFactory.getLogger(PostProgramHttpRepository.class);
    ...
    public String uploadCoverImage(Long programId, MultipartFile coverImage) {
        ...
        if (!validationResult.valid()) {
            logger.error("Cover image validation failed for program {}: {}", programId, validationResult.errorMessage());
     ...
     * Example: programs/123/cover/a1b2c3d4-e5f6-7890-abcd-ef1234567890.jpg
     *
