...
/**
 * Repository implementation for updating event images in R2 storage.
 * <p>
 * Only active when r2.enabled=true in application.properties.
 * Handles uploading replacement images and deleting old images.
 *
...
public class PatchEventHttpRepository implements PatchEventHttpDataAccess {

    private static final Logger logger = LoggerFactory.getLogger(PatchEventHttpRepository.class);
    ...
    public String uploadCoverImage(Long eventId, MultipartFile coverImage) {
        ...
        logger.info("Successfully uploaded replacement cover image for event {}: {}", eventId, key);
        return key;
    }
