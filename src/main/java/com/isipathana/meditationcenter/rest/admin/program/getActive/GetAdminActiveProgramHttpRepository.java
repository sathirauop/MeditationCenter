...
/**
 * Repository implementation for generating presigned URLs for active program images (admin).
...
public class GetAdminActiveProgramHttpRepository implements GetAdminActiveProgramHttpDataAccess {

    private static final Logger logger = LoggerFactory.getLogger(GetAdminActiveProgramHttpRepository.class);
    ...
    public Map<String, String> generatePresignedUrls(Set<String> imageKeys) {
        ...
        logger.info("Generated {} presigned URLs for active program images", urlMap.size());
        return urlMap;
    }
}
