...
/**
 * Repository implementation for generating presigned URLs for program images.
...
public class GetAdminProgramHttpRepository implements GetAdminProgramHttpDataAccess {

    private static final Logger logger = LoggerFactory.getLogger(GetAdminProgramHttpRepository.class);
