...
/**
 * Presenter for transforming MeditationProgram to PatchProgramResponse.
 * Generates presigned URLs for images if R2 is enabled.
 *
 * @author Sathira Basnayake
 */
@Component
public class PatchProgramPresenter implements PatchProgramResponseBuilder {

    @Autowired(required = false)
    private PatchProgramHttpDataAccess httpRepository;

    @Override
    public PatchProgramResponse build(MeditationProgram program) {
        ...
        return PatchProgramResponse.builder()
