...
/**
 * Repository implementation for generating presigned URLs for program images (public).
...
public class GetProgramHttpRepository implements GetProgramHttpDataAccess {

    private static final Logger logger = LoggerFactory.getLogger(GetProgramHttpRepository.class);
