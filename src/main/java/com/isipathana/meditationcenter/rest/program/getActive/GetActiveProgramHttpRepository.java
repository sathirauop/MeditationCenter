...
/**
 * Repository implementation for generating presigned URLs for active program images (public).
...
public class GetActiveProgramHttpRepository implements GetActiveProgramHttpDataAccess {

    private static final Logger logger = LoggerFactory.getLogger(GetActiveProgramHttpRepository.class);
