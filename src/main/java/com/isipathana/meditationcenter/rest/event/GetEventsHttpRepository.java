...
public class GetEventsHttpRepository implements GetEventsHttpDataAccess {

    private static final Logger logger = LoggerFactory.getLogger(GetEventsHttpRepository.class);
    ...
    public Map<String, String> generatePresignedUrls(Set<String> imageKeys) {
        ...
        return generatePresignedUrls(new ArrayList<>(imageKeys));
    }

    @Override
    public Map<String, String> generatePresignedUrls(List<String> imageKeys) {
        if (imageKeys == null || imageKeys.isEmpty()) {
            return Map.of();
        }
